...
exports.ScheduleApi = exports.ScheduleApiFactory = exports.ScheduleApiFp = exports.ScheduleApiAxiosParamCreator = exports.ScenarioApi = exports.ScenarioApiFactory = exports.ScenarioApiFp = exports.ScenarioApiAxiosParamCreator = exports.ResultApi = exports.ResultApiFactory = exports.ResultApiFp = exports.ResultApiAxiosParamCreator = exports.TestPlanResultStatusEnum = exports.TestPlanCapabilityResultStatusEnum = exports.TestCaseResultStatusEnum = exports.InlineResponse200StatusEnum = void 0;
const axios_1 = __importDefault(__nccwpck_require__(6545));
// Some imports not used depending on template conditions
// @ts-ignore
const common_1 = __nccwpck_require__(6143);
// @ts-ignore
const base_1 = __nccwpck_require__(174);
/**
    * @export
    * @enum {string}
    */
...
(function (InlineResponse200StatusEnum) {
    InlineResponse200StatusEnum["Queuing"] = "queuing";
    InlineResponse200StatusEnum["Waiting"] = "waiting";
    InlineResponse200StatusEnum["Running"] = "running";
    InlineResponse200StatusEnum["Passed"] = "passed";
    InlineResponse200StatusEnum["Failed"] = "failed";
    InlineResponse200StatusEnum["Skipped"] = "skipped";
})(InlineResponse200StatusEnum = exports.InlineResponse200StatusEnum || (exports.InlineResponse200StatusEnum = {}));
/**
    * @export
    * @enum {string}
    */
var TestCaseResultStatusEnum;
(function (TestCaseResultStatusEnum) {
    TestCaseResultStatusEnum["Waiting"] = "waiting";
    TestCaseResultStatusEnum["Running"] = "running";
    TestCaseResultStatusEnum["Passed"] = "passed";
    TestCaseResultStatusEnum["Failed"] = "failed";
    TestCaseResultStatusEnum["Skipped"] = "skipped";
})(TestCaseResultStatusEnum = exports.TestCaseResultStatusEnum || (exports.TestCaseResultStatusEnum = {}));
/**
    * @export
    * @enum {string}
    */
var TestPlanCapabilityResultStatusEnum;
(function (TestPlanCapabilityResultStatusEnum) {
    TestPlanCapabilityResultStatusEnum["Waiting"] = "waiting";
    TestPlanCapabilityResultStatusEnum["Running"] = "running";
    TestPlanCapabilityResultStatusEnum["Passed"] = "passed";
    TestPlanCapabilityResultStatusEnum["Failed"] = "failed";
    TestPlanCapabilityResultStatusEnum["Skipped"] = "skipped";
})(TestPlanCapabilityResultStatusEnum = exports.TestPlanCapabilityResultStatusEnum || (exports.TestPlanCapabilityResultStatusEnum = {}));
/**
    * @export
    * @enum {string}
    */
var TestPlanResultStatusEnum;
(function (TestPlanResultStatusEnum) {
    TestPlanResultStatusEnum["Waiting"] = "waiting";
    TestPlanResultStatusEnum["Running"] = "running";
    TestPlanResultStatusEnum["Passed"] = "passed";
    TestPlanResultStatusEnum["Failed"] = "failed";
    TestPlanResultStatusEnum["Skipped"] = "skipped";
})(TestPlanResultStatusEnum = exports.TestPlanResultStatusEnum || (exports.TestPlanResultStatusEnum = {}));
/**
...
const ResultApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        projectsProjectIdResultsGet: (projectId, page, perPage, testPlanId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'projectId' is not null or undefined
            common_1.assertParamExists('projectsProjectIdResultsGet', 'projectId', projectId);
         ...
         * @throws {RequiredError}
         */
        projectsProjectIdResultsIdGet: (projectId, id, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'projectId' is not null or undefined
            common_1.assertParamExists('projectsProjectIdResultsIdGet', 'projectId', projectId);
            // verify required parameter 'id' is not null or undefined
            common_1.assertParamExists('projectsProjectIdResultsIdGet', 'id', id);
...
const ResultApiFp = function (configuration) {
    const localVarAxiosParamCreator = exports.ResultApiAxiosParamCreator(configuration);
    return {
        /**
         * # List results The same content as listed on https://app.autify.com/projects/{project_id}/results will be returned.
         * @param {number} projectId For example, the &#x60;{project_id}&#x60; for the following URL is **1**.&lt;br/&gt; &#x60;https://app.autify.com/projects/1/results&#x60;
         ...
         * @throws {RequiredError}
         */
        projectsProjectIdResultsGet(projectId, page, perPage, testPlanId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.projectsProjectIdResultsGet(projectId, page, perPage, testPlanId, options);
         ...
         * @throws {RequiredError}
         */
        projectsProjectIdResultsIdGet(projectId, id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.projectsProjectIdResultsIdGet(projectId, id, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
    };
...
const ResultApiFactory = function (configuration, basePath, axios) {
    const localVarFp = exports.ResultApiFp(configuration);
    return {
        /**
         * # List results The same content as listed on https://app.autify.com/projects/{project_id}/results will be returned.
         * @param {number} projectId For example, the &#x60;{project_id}&#x60; for the following URL is **1**.&lt;br/&gt; &#x60;https://app.autify.com/projects/1/results&#x60;
...
class ResultApi extends base_1.BaseAPI {
     ...
     */
    projectsProjectIdResultsGet(projectId, page, perPage, testPlanId, options) {
        return exports.ResultApiFp(this.configuration).projectsProjectIdResultsGet(projectId, page, perPage, testPlanId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * # Get a result The same content as shown on https://app.autify.com/projects/{project_id}/results/{id} will be returned.
     * @param {number} projectId For example, the &#x60;{project_id}&#x60; for the following URL is **1**.&lt;br/&gt; &#x60;https://app.autify.com/projects/1/results/4&#x60;
     ...
     */
    projectsProjectIdResultsIdGet(projectId, id, options) {
        return exports.ResultApiFp(this.configuration).projectsProjectIdResultsIdGet(projectId, id, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const ScenarioApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        projectsProjectIdScenariosGet: (projectId, page, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'projectId' is not null or undefined
            common_1.assertParamExists('projectsProjectIdScenariosGet', 'projectId', projectId);
         ...
         * @throws {RequiredError}
         */
        projectsProjectIdScenariosIdGet: (projectId, id, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'projectId' is not null or undefined
            common_1.assertParamExists('projectsProjectIdScenariosIdGet', 'projectId', projectId);
            // verify required parameter 'id' is not null or undefined
            common_1.assertParamExists('projectsProjectIdScenariosIdGet', 'id', id);
...
const ScenarioApiFp = function (configuration) {
    const localVarAxiosParamCreator = exports.ScenarioApiAxiosParamCreator(configuration);
    return {
        /**
         * # List scenarios
         * @param {number} projectId For example, the &#x60;{project_id}&#x60; for the following URL is **1**.&lt;br/&gt; &#x60;https://app.autify.com/projects/1/scenarios&#x60;
         ...
         * @throws {RequiredError}
         */
        projectsProjectIdScenariosGet(projectId, page, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.projectsProjectIdScenariosGet(projectId, page, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        projectsProjectIdScenariosIdGet(projectId, id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.projectsProjectIdScenariosIdGet(projectId, id, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
    };
...
const ScenarioApiFactory = function (configuration, basePath, axios) {
    const localVarFp = exports.ScenarioApiFp(configuration);
    return {
        /**
         * # List scenarios
         * @param {number} projectId For example, the &#x60;{project_id}&#x60; for the following URL is **1**.&lt;br/&gt; &#x60;https://app.autify.com/projects/1/scenarios&#x60;
 ...
 * @extends {BaseAPI}
 */
class ScenarioApi extends base_1.BaseAPI {
    /**
     * # List scenarios
     * @param {number} projectId For example, the &#x60;{project_id}&#x60; for the following URL is **1**.&lt;br/&gt; &#x60;https://app.autify.com/projects/1/scenarios&#x60;
     * @param {number} [page] The number of page returns.
     ...
     */
    projectsProjectIdScenariosGet(projectId, page, options) {
        return exports.ScenarioApiFp(this.configuration).projectsProjectIdScenariosGet(projectId, page, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * # Get a scenario
     * @param {number} projectId For example, the &#x60;{project_id}&#x60; for the following URL is **1**.&lt;br/&gt; &#x60;https://app.autify.com/projects/1/scenarios/2&#x60;
     ...
     */
    projectsProjectIdScenariosIdGet(projectId, id, options) {
        return exports.ScenarioApiFp(this.configuration).projectsProjectIdScenariosIdGet(projectId, id, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const ScheduleApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        schedulesIdPost: (id, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            common_1.assertParamExists('schedulesIdPost', 'id', id);
...
const ScheduleApiFp = function (configuration) {
    const localVarAxiosParamCreator = exports.ScheduleApiAxiosParamCreator(configuration);
    return {
        /**
         * _Note: the Schedule is the TestPlan now._<br/><br/> In order to request executing the test plan `https://app.autify.com/projects/1/test_plans/3` , specify the following URL for API call `https://app.autify.com/api/v1/schedules/3` .<br/><br/> # Run TestPlan
         * @param {number} id For example, the &#x60;{id}&#x60; for the following URL is **3**. &#x60;https://app.autify.com/projects/1/test_plans/3&#x60;
         ...
         * @throws {RequiredError}
         */
        schedulesIdPost(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.schedulesIdPost(id, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
    };
...
const ScheduleApiFactory = function (configuration, basePath, axios) {
    const localVarFp = exports.ScheduleApiFp(configuration);
    return {
        /**
         * _Note: the Schedule is the TestPlan now._<br/><br/> In order to request executing the test plan `https://app.autify.com/projects/1/test_plans/3` , specify the following URL for API call `https://app.autify.com/api/v1/schedules/3` .<br/><br/> # Run TestPlan
         * @param {number} id For example, the &#x60;{id}&#x60; for the following URL is **3**. &#x60;https://app.autify.com/projects/1/test_plans/3&#x60;
...
class ScheduleApi extends base_1.BaseAPI {
     ...
     */
    schedulesIdPost(id, options) {
        return exports.ScheduleApiFp(this.configuration).schedulesIdPost(id, options).then((request) => request(this.axios, this.basePath));
    }
}
...
// @ts-ignore
const axios_1 = __importDefault(__nccwpck_require__(6545));
exports.BASE_PATH = "https://app.autify.com/api/v1".replace(/\/+$/, "");
/**
 *
 * @export
 */
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__nccwpck_require__(5418), exports);
__exportStar(__nccwpck_require__(2453), exports);
    ...
    run(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                core.debug(`Failed to run test:${util_1.inspect(err)}`);
            }
        });
    }
}
exports.Autifyer = Autifyer;
exports.default = {
    Autifyer
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(2186));
const autifyer_1 = __nccwpck_require__(1543);
const util_1 = __nccwpck_require__(1669);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const autifyer = new autifyer_1.Autifyer(inputs);
            yield autifyer.run(inputs.id);
        }
        catch (error) {
